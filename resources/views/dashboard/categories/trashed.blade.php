<x-layout :title="__('categories.trashed')" :breadcrumbs="['dashboard.categories.trashed']">
        ...
        <tr>
          <th colspan="100">
            <x-check-all-force-delete
                    ...
                    :resource="__('categories.plural')"></x-check-all-force-delete>
            <x-check-all-restore
                    type="{{ \App\Models\Category::class }}"
                    :resource="__('categories.plural')"></x-check-all-restore>
          </th>
        </tr>
        <tr>
