<x-layout :title="__('products.trashed')" :breadcrumbs="['dashboard.products.trashed']">
        ...
        <tr>
          <th colspan="100">
            <x-check-all-force-delete
                    ...
                    :resource="__('products.plural')"></x-check-all-force-delete>
            <x-check-all-restore
                    type="{{ \App\Models\Fee::class }}"
                    :resource="__('products.plural')"></x-check-all-restore>
          </th>
        </tr>
        <tr>
